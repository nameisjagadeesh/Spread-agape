...
<body>
	<nav class="navbar navbar-expand-lg-navbar-Light bg-dark">
		<div class="container-fluid">
			...
			</a> <a href="index.jsp">Home</a> </a> <a href="UpdateProfile.jsp">Update</a>
		</div>
	</nav>
	...
	<div align="center">
		...
		<form action="sign">
			<table>
				<tr>
					<td>Enter UserId</td>
					<td><input type="text" name="userId" id=""
						onchange="ValidName()" placeholder="enter ur userId"> <span
		...
		<script>
			function ValidName() {
				...
				if (uservalue != null && uservalue != ""
						&& uservalue.length > 2 && uservalue.length < 25) {
