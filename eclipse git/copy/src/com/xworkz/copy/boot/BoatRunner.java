...
public class BoatRunner {
	...
	System.out.println("passed the arguments in boatRunner");		
		  Boat boat2=new Boat("lintac");
		  System.out.println(boat2.companyname);
		  Boat boat3=new Boat(5,"blue");
		  ...
		  Boat boat5=new Boat("rudra","Green");
		  System.out.println(boat5.name);
		  System.out.println(boat5.colour);
		  Boat boat6=new Boat(6, "Jagadeesh", "white");
