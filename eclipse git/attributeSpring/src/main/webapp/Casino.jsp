			...
			<form action="casino" method="get">
				...
				<div class="form-check">
					<input type="radio" class="form-check-input" id="radio2"
						...
						class="form-check-label" for="radio2"></label> <br>
						<input type="radio" 
						class="form-check-input" id="radio2" name="freeFood" value="false">Free
					Food :No <label class="form-check-label" for="radio2"></label>
				</div>
